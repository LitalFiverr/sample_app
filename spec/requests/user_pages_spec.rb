...
describe "User Pages" do
    ...
    describe "signup" do
      ...
      describe "follow/unfollow buttons" do
        ...
        before {sign_in user_to_show}

        describe "following user" do
          before {visit user_path(other_user)}

          it "should increment the followed user count" do
            expect{click_button ("Follow")}.to change(user_to_show.followed_users, :count).by(1)
          end
        ...
        describe "unfollowing a user" do
          before do
            user_to_show.follow!(other_user)
          ...
          it "should decrement the followed user count" do
            ...
            end.to change(user_to_show.followed_users, :count).by(-1)
          end
